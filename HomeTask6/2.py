...
from chess import has_attacking_queens

queens = []
for _ in range(8):
    x, y = map(int, input("Введите координаты ферзя: ").split())
    queens.append((x, y))

if has_attacking_queens(queens):
    print("Есть пара бьющих друг друга ферзей")
else:
    print("Нет пары бьющих друг друга ферзей")